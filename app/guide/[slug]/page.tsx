...
<main className='max-w-scren-2xl m-auto bg-white'>
    ...
    <div className="bg-white w-[70%] rounded p-3 shadow">
        ...
        <h1 className="font-bold text-6xl">Gardening 101</h1>
        </div>
        {/* TITLE */}
        {/* RATINGS */}
        ...
        <div className="">
            <p className="text-reg ml-4">62 Reviews</p>
        </div>
        </div>
        {/* RATINGS */}
        {/* DESCRiPTION */}
        ...
        <div className="">
            ...
            <div className="flex">
                ...
                <p className='text-center'>Tom Green</p>
                </div>
                ...
                <div className="mt-5">
                    <p className="text-lg font-light">
                    Tom is one of the most knowledgable people I have ever met about all things plants! I would love to crawl into his brain and discover the real details this man really knows!
                    </p>
                </div>
                </div>
            </div>
